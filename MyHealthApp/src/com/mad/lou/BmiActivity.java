...
public class BmiActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		bmiBar = (BmiProgress) findViewById(R.id.progressBarwithText);
		Button b = (Button) findViewById(R.id.button_chart);
		b.setOnClickListener(new OnClickListener() {
    		public void onClick(View v) {
    			Intent i = new Intent(BmiActivity.this,  FoodDiaryActivity.class);
          		BmiActivity.this.startActivity(i);
          		Log.i("starting intent", "going to food diary");
    		}
    	});
	...
	private int interpretBMI(float bmiValue) {
		if (bmiValue < 16) {
			bmiBar.setProgress(R.drawable.progressbar);
			bmiBar.setProgress(R.drawable.progressbar);
			bmiBar.setText("you need to eat more");
		    bmiBar.setProgress(20);
		   	bmiBar.setTextSize(20);
			return R.string.bmiSUnder;
		} else if (bmiValue < 18.5) {
			bmiBar.setProgress(R.drawable.progressbar);
			bmiBar.setText("try eating more carbs");
		    bmiBar.setProgress(40);
		   	bmiBar.setTextSize(20);
			return R.string.bmiUnder;
		} else if (bmiValue < 25) {
			bmiBar.setProgress(R.drawable.progressbar);
			bmiBar.setText("spot on, maintaining is key");
		    bmiBar.setProgress(40);
		   	bmiBar.setTextSize(20);
		   	bmiBar.setTextColor(R.color.colorRed);
			bmiBar.setBackgroundColor(Color.GREEN);
			return R.string.bmiNormal;
		} else if (bmiValue < 30) {
			
			bmiBar.setText("overweight");
		    bmiBar.setProgress(70);
		   	bmiBar.setTextSize(20);
			return R.string.bmiOver;
		} else {
			
			bmiBar.setProgress(R.drawable.progressbar);
			bmiBar.setText("you need to watch your diet");
		    bmiBar.setProgress(90);
		   	bmiBar.setTextSize(18);
	...
	public void initializeSpinnerAdapters() {
		...
		// loading 3'0" to 7"6' to the height in feet/inch
		k = 59;
		for (int i = 3; i < 8; i++) {
			for (int j = 0; j < 7; j++) {
